  ...
  return (
    <section className="border-t border-[#303034] px-6 py-24 md:px-10 md:py-32">
      <div className="mx-auto max-w-[1400px]">
        ...
        <h2 className="mt-4 font-heading text-[clamp(2.25rem,5vw,3.5rem)] font-bold tracking-[-0.02em] text-[#F2F0EA]">
          Why work with me.
        </h2>

        <div className="mt-12 grid gap-px border border-[#303034] bg-[#303034] sm:grid-cols-2 lg:grid-cols-4">
          {points.map((pt, idx) => (
            <div
              key={pt.title}
              className="group h-full bg-[#0B0B0D] p-8 transition-colors duration-300 hover:bg-[#141416]"
            >
